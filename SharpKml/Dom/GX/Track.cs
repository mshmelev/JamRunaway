...
namespace SharpKml.Dom.GX
{
    ...
    public sealed class Track : Geometry
    {
		...
		/// <summary>
		/// Returns unordered list of all child elements
		/// Added by Max Shmelev
		/// </summary>
		/// <returns></returns>
		public List<object> GetChildElements()
		{
			...
			{
				if (child is WhenElement)
					res.Add(((WhenElement)child).DateTimeValue);
				else if (child is CoordElement)
					res.Add(((CoordElement)child).Value);
				else if (child is AnglesElement)
					res.Add(((AnglesElement)child).Value);
			}
        ...
        private class WhenElement : Element, ICustomElement
        {
	        ...
	        public DateTime? DateTimeValue
	        {
				...
				{
					DateTime d;
					if (!DateTime.TryParse(_value, out d))
						return null;
